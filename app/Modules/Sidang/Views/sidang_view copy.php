...
<thead>
    <tr>
        <th width="5%"> <input type="checkbox" id="checkAll"> </th> <th width="30%">Nama Terdakwa</th>                                <th width="20%">Nomor Perkara</th>                               <th width="25%">Jaksa Penuntut umum</th>                       <th width="20%" class="text-center">Aksi</th>                    <th class="d-none">Tanggal</th>                                 </tr>
</thead>
    ...
    <script>
        var table;
        // 🛑 KOREKSI 1: Ambil Base URL secara mentah dari PHP
        ...
        function loadData(selectedDate) {
            ...
            if (selectedDate) {
                ...
                if (parts.length === 3) {
                    dbFormatDate = parts[2] + '-' + parts[1] + '-' + parts[0];
                }
            }
            
            // 🛑 KOREKSI 2: Bangun URL dengan aman
            // Hapus slash di akhir Base URL jika ada, lalu tambahkan rute API
